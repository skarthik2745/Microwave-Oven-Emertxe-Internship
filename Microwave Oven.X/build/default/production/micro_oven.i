...
void display_power_screen(void)
{
    ...
    clcd_print("Developed By", (0xC0 + 2));

    clcd_print("KARTHIK S", (0x90 + 4));
    for(unsigned char i=0; i<16;i++){
        clcd_putch(0xFF,(0xD0 + i));
        _delay((unsigned long)((100)*(20000000/4000.0)));
    }
    ...
    clcd_print("EMERTXE", (0xC0 + 5));

    clcd_print("Embedded System", (0x90 + 1));
    clcd_print("Internship", (0xD0 + 2));
    alarm();
    _delay((unsigned long)((3000)*(20000000/4000.0)));
    clear_screen();
}
...
void set_time(unsigned char key, unsigned char reset_flag)
{
    ...
    if(display_blank){
        ...
        clcd_putch(minn/10+'0',(0xC0 + 5));
        clcd_putch(minn%10+'0',(0xC0 + 6));
...
void set_temp(unsigned char key,unsigned char reset_flag)
{
    ...
    else if(key=='#')
    {
        ...
        clcd_print("Time Left:",(0x90 + 1));
        clcd_putch('s',(0x90 + 14));
        while(pre_heat)
        {

            clcd_putch((pre_heat/10)%10+'0',(0x90 + 12));
            clcd_putch(pre_heat%10+'0',(0x90 + 13));
        }
        RC1=1;
        _delay((unsigned long)((2000)*(20000000/4000.0)));
        RC1=0;
...
void display_time(void)
{
    ...
    clcd_putch(minn/10+'0',(0x80 + 9));
    clcd_putch(minn%10+'0',(0x80 + 10));
    clcd_putch(':',(0x80 + 11));
